class Farmacia:
   def __init__(self):
       self.medicamentos_disponiveis = {"Paracetamol": 10, "Aspirina": 15, "Antibiótico X": 5}
       self.pedidos = []

#imprimir conversa inicial
...
#chamando a classe Farmacia para iniciar o programa
